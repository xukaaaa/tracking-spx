...
const getStatusColor = (status: string) => {
  ...
  // Đang giao hàng - Xanh dương (blue)
  ...
  // Còn lại (đang chờ lấy hàng, lấy hàng, trung chuyển kho...) - Cam (Orange)
  else {
